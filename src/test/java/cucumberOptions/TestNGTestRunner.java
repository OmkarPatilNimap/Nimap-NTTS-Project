...
@CucumberOptions(features = "src/test/java/features", glue = "nimap.ntts.stepDefinitions", monochrome = true, tags = "@UserLoginTest or @EmployeeListVerificationTest or @TopicsListVerificationTest", plugin = {
